                    ...
                    steps {
                        script {
                         //   dir("${env.SPRING_BOOT_DIR}") {
                                ...
                                powershell '''  
                                Start-Process -FilePath "java" -ArgumentList "-jar target/sb-mvc-websocket-2-0.0.1-SNAPSHOT.jar" -NoNewWindow -RedirectStandardOutput "app-front.log" -RedirectStandardError "app-error.log"  
                                '''
                         //   }
                        }
                    }
